...
RECIPIENTS    = ["dphm57.1@gmail.com", "minh_dao@apple.com"]
...
<div class="story-map">
  <a href="#s1" class="story-pill active">01 · Invisible Giant</a>
...
# ── Upload to GCS ─────────────────────────────────────────────────
def upload_gcs(html: str, month_str: str) -> str:
    fname  = f"report-{month_str}.html"
